...
inclusive, resultado de python scripts/smoke_nvidia.py que rodei antes de vir pra ca:
3/3 OK.

- Chat completion: LENTO — 24,8 s (D-080). Capacidade viva, não é EOL.
- Embedding: PASSOU — 1024 dims, PT e crosslingual separando bem.
- Reranking: PASSOU — Cohere rerank-v3.5, ordem correta, margem 0,27. A cota do mês voltou a responder.
```
